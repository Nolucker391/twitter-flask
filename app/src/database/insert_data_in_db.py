...
from models import ApiKey, Image, Like, Session, Tweets, User
...
tweets_data = [
    {
        "author_id": 1,
        "content":
            "My world! It's are first and test message on the messenger. Go to like on the post :D",
    },
    {
        "author_id": 2,
        "content": "Hey! I created a good messenger for communication ♥. Thanks my friend! Have a good day! ♡",
    },
    {
        "author_id": 3,
        "content": "I'm have a 200k on my balance Bitcoin!🤤🫡 Niiiceee!♡",
    },
    {
        "author_id": 4,
        "content": "I built a beast, a powerful gaming PC with the characteristics: RTX 4090, i9-14900K, 64GB Ram and M2 SSD for 2TB.💻",
    },
    {
        "author_id": 5,
        "content": "Come on 2025. The presidential position has been waiting for me. Good Luck.",
    },
